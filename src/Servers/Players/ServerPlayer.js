...
var ServerPlayer = /** @class */ (function (_super) {
    ...
    ServerPlayer.editable = ['name', 'description', 'restrict', 'ips'];
    __decorate([
        swagger_1.ApiProperty({ type: function () { return Server_1.Server; } }),
        typeorm_1.ManyToOne(function () { return Server_1.Server; })
    ], ServerPlayer.prototype, "server");
    __decorate([
        swagger_1.ApiProperty(),
        typeorm_1.Column()
    ], ServerPlayer.prototype, "name");
    __decorate([
        swagger_1.ApiProperty(),
        typeorm_1.Column()
    ], ServerPlayer.prototype, "description");
    __decorate([
        swagger_1.ApiProperty(),
        typeorm_1.Column()
    ], ServerPlayer.prototype, "restrict");
    __decorate([
        swagger_1.ApiProperty(),
        typeorm_1.Column()
    ], ServerPlayer.prototype, "ips");
    ServerPlayer = __decorate([
        typeorm_1.Entity('servers_players'),
